...
@section('content')
    ...
    <div class='card'>
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#tab_routes" data-toggle="tab">{!! trans('general.tabs.routes') !!}</a>
            </li>
            <li class="nav-item">
...
@section('body_bottom')
    <!-- Select2 js -->
    @include('admin.configuration.partials._body_bottom_select2_js_route_search')
    @include('admin.configuration.partials._body_bottom_select2_js_role_search')
@endsection
